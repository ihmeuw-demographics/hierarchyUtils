...
agg_age_mapping
iran_pop_aggs <- hierarchyUtils::agg(dt = iran_pop,
                                     id_cols = id_cols,
...
sex_mapping
iran_pop_aggs_both_sexes <- hierarchyUtils::agg(dt = iran_pop_aggs,
                                                id_cols = id_cols,
                                                value_cols = value_cols,
                                                col_stem = "sex",
...
iran_pop_aggs_location <- hierarchyUtils::agg(dt = iran_pop_aggs,
                                              id_cols = id_cols,
                                              value_cols = value_cols,
                                              col_stem = "location",
                                              col_type = "categorical",
